...
export const state = {
  processing: [
    {
      title: 'Coffee Nursery',
      description: 'The nursery produces 70,000 - 100,000 seedlings per year both Clonal & Elite approved by UCDA.',
    ...
    {
      title: 'Weeding',
      description: 'Weed control is carried out through cycles of slashing alternating with application of glyphosate',
      filename: 'nursery.jpg',
    },
    {
